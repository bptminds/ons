databaseChangeLog = {
	...
	changeSet(author: "suneel (generated)", id: "1393596880665-1") {
	...
	changeSet(author: "suneel (generated)", id: "1393596880665-3") {
	...
	changeSet(author: "suneel (generated)", id: "1393596880665-5") {
	...
	changeSet(author: "suneel (generated)", id: "1393596880665-6") {
		addPrimaryKey(columnNames: "role_id, user_id", constraintName: "user_rolePK", tableName: "user_role")
	}

	changeSet(author: "suneel (generated)", id: "1393596880665-11") {
		createIndex(indexName: "email_uniq_1393596880593", tableName: "person", unique: "true") {
			column(name: "email")
		}
	}

	changeSet(author: "suneel (generated)", id: "1393596880665-12") {
		createIndex(indexName: "authority_uniq_1393596880604", tableName: "role", unique: "true") {
			column(name: "authority")
		}
	}

	changeSet(author: "suneel (generated)", id: "1393596880665-13") {
		createSequence(sequenceName: "hibernate_sequence")
	}

	changeSet(author: "suneel (generated)", id: "1393596880665-9") {
	...
	changeSet(author: "suneel (generated)", id: "1393596880665-10") {
